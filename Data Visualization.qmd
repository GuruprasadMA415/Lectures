...
head(penguins)
ggplot(penguins, aes(x = body_mass_g, y = bill_length_mm, color = species)) + geom_point() + facet_wrap(~ species) 
...
ggplot(penguins, aes(x = bill_length_mm, y = flipper_length_mm)) + geom_violin()
```
